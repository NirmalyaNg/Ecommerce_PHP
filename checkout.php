    ...
    <div class="col-lg-6 col-md-8 col-12 m-auto">
      <form method="post">
        <div class="form-group">
          ...
          <input type="text" class='form-control' disabled name="cust_name" id="cust_name" value="<?php echo $cust_name; ?>">
          <input type="hidden" class='form-control'  name="cust_name" id="cust_name" value="<?php echo $cust_name; ?>">
        </div>
        <div class="form-group">
          <label for="">CUSTOMER EMAIL</label>
          <input type="email" disabled class='form-control' id="cust_email" value="<?php echo $cust_mail; ?>">
          <input type="hidden" name="cust_email"  class='form-control' id="cust_email" value="<?php echo $cust_mail; ?>">
        </div>
        <div class="form-group">
          <label for="">SHIPPING ADDRESS</label>
          <textarea name="address" id="" class="form-control" style="resize:none;" disabled><?php echo $address; ?></textarea>
        </div>
        <div class="row">
          <div class="col-6">
            <label for="">STATE</label>
            <input type="text" disabled name="state" value="<?php echo $state; ?>" class="form-control">
          </div>
          <div class="col-6">
            <label for="">CITY</label>
            <input type="text" disabled name="city" value="<?php echo $city; ?>" class="form-control">
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            <label for="">Total Amount</label>
            <input type="text" name="total" value="<?php echo $total; ?>" class="form-control" disabled >
          </div>
        </div>
